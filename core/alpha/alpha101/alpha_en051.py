"""Real WorldQuant Alpha101 formula — alpha051"""
import numpy as np
import pandas as pd
...
class Alpha051_en(AlphaFactor):
    ...
    def description(self) -> str:
        return "(((((delay(close,20)-delay(close,10))/10)-((delay(close,10)-close)/10))<-0.05)?1:((-1*1)*(close-delay(close,1)))"
