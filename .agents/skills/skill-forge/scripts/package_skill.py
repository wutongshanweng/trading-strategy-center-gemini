...
# ponytail: scripts/ has no __init__.py — load sibling module directly
_spec = spec_from_loader("quick_validate", SourceFileLoader("quick_validate", str(Path(__file__).parent / "quick_validate.py")))
_quick_validate = module_from_spec(_spec)
