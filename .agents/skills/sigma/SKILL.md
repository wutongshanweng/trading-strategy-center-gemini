---
name: sigma
description: "Personalized 1-on-1 AI tutor using Bloom's 2-Sigma mastery learning. Guides users through any topic with Socratic questioning, adaptive pacing, interleaving, misconception tracking, and rich visual output (HTML dashboards, Excalidraw concept maps). Use when user wants to learn something, study a topic, understand a concept, requests tutoring, says 'teach me', 'I want to learn', 'explain X to me step by step', 'help me understand', 'master this', 'tutor me in X', 'study session', 'learning session', or invokes /sigma. Arguments: --level (beginner/intermediate/advanced), --lang (language), --resume (continue previous session), --visual (force rich visuals). Triggers on: learn, study, teach, tutor, understand, master, explain step by step, Socratic, concept explanation, skill acquisition."
---
